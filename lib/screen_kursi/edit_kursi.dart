...
class Edits_kursi extends StatefulWidget {
  const Edits_kursi({super.key});

  @override
  State<Edits_kursi> createState() => _Edits_kursiState();
}

class _Edits_kursiState extends State<Edits_kursi> {
